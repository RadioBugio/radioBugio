		...
		<>
			...
			<div className='container-default '>
				...
				<div className=' w-2/3 place-self-center-safe'>
					...
					zona fronteiriça entre o rio e o mar. Aqui, o som é sensor, testemunho e ficção. <br></br>
					...
					seus sedimentos e sinais. <br></br>
					Cada emissão é um momento poroso: parte arquivo, parte chamada, parte resposta. Começamos a partir do farol do Bugio, mas as correntes estendem-se - mergulhamos no desconhecido, em direção a
					histórias e futuros especulativos. O nosso foco está na escuta colectiva e na inteligência subtil dos ecossistemas. <br></br>A <i>Rádio Bugio </i> é parte de uma experiência em curso - um

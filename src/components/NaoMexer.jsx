...
export function NaoMexer({ entrevistas }) {
	...
	return (
		<>
			...
			<div className='text-[#eaebde] relative container-default bg-blue-950 '>
				...
				{Object.entries(grouped).map(([date, episodes]) => {
					...
					return (
						<div key={date} className='mb-10 flex flex-col   bg-blue-700  items-center '>
							<div>

				...
				<div className='flex flex-col items-center '>
					<ul className='grid grid-cols-4 gap-4 w-2/3'>
						{entrevistas.map(ep => {
							...
							return (
								<li key={ep._id} onClick={() => toggle(ep._id)} className='relative  border-[.5px] border-[#484848] hover:opacity-50  rounded-2xl p-2 transition duration-500  cursor-pointer'>
